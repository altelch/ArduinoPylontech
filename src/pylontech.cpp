/*                    GNU GENERAL PUBLIC LICENSE
	...
	Code by zivillian https://github.com/zivillian/esp32-pylontech
    Changes by altelch.
*/
...
void Pylonframe::PylonSerialnumber::json(DynamicJsonDocument &doc, uint8_t module){
  doc["pylontech"][String(module)]["Serialnumber"] = Serialnumber();
}
...
void Pylonframe::PylonManufacturerInfo::json(DynamicJsonDocument &doc, uint8_t module){
    doc["pylontech"][String(module)]["Battery"] = Battery();
    doc["pylontech"][String(module)]["SoftwareVersion"] = SoftwareMajorVersion() + "." + SoftwareMinorVersion();
    doc["pylontech"][String(module)]["Manufacturer"] = Manufacturer();
}
...
void Pylonframe::PylonFirmwareInfo::json(DynamicJsonDocument &doc, uint8_t module){
    doc["pylontech"][String(module)]["Address"] = Address();
    doc["pylontech"][String(module)]["ManufacturerVersion"] = ManufactureMajorVersion() + "." + ManufactureMinorVersion();
    doc["pylontech"][String(module)]["MainlineVersion"] = String(MainlineMajorVersion()) + "." + String(MainlineMinorVersion()) + "." + String(MainlinePatchVersion());
}
...
void Pylonframe::PylonSystemParameter::json(DynamicJsonDocument &doc, uint8_t module){
    doc["pylontech"][String(module)]["Sysparam"]["UnreadAlarmValueChange"] = InfoFlags() & PylonInfoFlags::UnreadAlarmValueChange?"true":"false";
    doc["pylontech"][String(module)]["Sysparam"]["UnreadSwitchingValueChange"] = InfoFlags() & PylonInfoFlags::UnreadSwitchingValueChange?"true":"false";
    doc["pylontech"][String(module)]["Sysparam"]["CellHighVoltageLimit"] = CellHighVoltageLimit();
    doc["pylontech"][String(module)]["Sysparam"]["CellLowVoltageLimit"] = CellLowVoltageLimit();
    doc["pylontech"][String(module)]["Sysparam"]["CellUnderVoltageLimit"] = CellUnderVoltageLimit();
    doc["pylontech"][String(module)]["Sysparam"]["ChargeHighTemperatureLimit"] = ChargeHighTemperatureLimit();
    doc["pylontech"][String(module)]["Sysparam"]["ChargeLowTemperatureLimit"] = ChargeLowTemperatureLimit();
    doc["pylontech"][String(module)]["Sysparam"]["ChargeCurrentLimit"] = ChargeCurrentLimit();
    doc["pylontech"][String(module)]["Sysparam"]["ModuleHighVoltageLimit"] = ModuleHighVoltageLimit();
    doc["pylontech"][String(module)]["Sysparam"]["ModuleLowVoltageLimit"] = ModuleLowVoltageLimit();
    doc["pylontech"][String(module)]["Sysparam"]["ModuleUnderVoltageLimit"] = ModuleUnderVoltageLimit();
    doc["pylontech"][String(module)]["Sysparam"]["DischargeHighTemperatureLimit"] = DischargeHighTemperatureLimit();
    doc["pylontech"][String(module)]["Sysparam"]["DischargeLowTemperatureLimit"] = DischargeLowTemperatureLimit();
    doc["pylontech"][String(module)]["Sysparam"]["DischargeCurrentLimit"] = DischargeCurrentLimit();
}
...
void Pylonframe::PylonChargeDischargeManagementInfo::json(DynamicJsonDocument &doc, uint8_t module){
    doc["pylontech"][String(module)]["ChgMgmt"]["ChargeVoltageLimit"] = ChargeVoltageLimit();
    doc["pylontech"][String(module)]["ChgMgmt"]["DischargeVoltageLimit"] = DischargeVoltageLimit();
    doc["pylontech"][String(module)]["ChgMgmt"]["ChargeCurrentLimit"] = ChargeCurrentLimit();
    doc["pylontech"][String(module)]["ChgMgmt"]["DischargeCurrentLimit"] = DischargeCurrentLimit();
    doc["pylontech"][String(module)]["ChgMgmt"]["ChargeEnabled"] = Status() & ChargeDischargeStatus::ChargeEnabled?"true":"false";
    doc["pylontech"][String(module)]["ChgMgmt"]["DischargeEnabled"] = Status() & ChargeDischargeStatus::DischargeEnabled?"true":"false";
    doc["pylontech"][String(module)]["ChgMgmt"]["ChargeImmediately1"] = Status() & ChargeDischargeStatus::ChargeImmediately1?"true":"false";
    doc["pylontech"][String(module)]["ChgMgmt"]["ChargeImmediately2"] = Status() & ChargeDischargeStatus::ChargeImmediately2?"true":"false";
    doc["pylontech"][String(module)]["ChgMgmt"]["FullChargeRequest"] = Status() & ChargeDischargeStatus::FullChargeRequest?"true":"false";
}
...
AlarmFlag Pylonframe::PylonAlarmInfo::TemperatureCell13to16(){
...
void Pylonframe::PylonAlarmInfo::print(Print *out) {
    ...
    out->printf("TemperatureCell13to16: %s\n", Name(TemperatureCell13to16()).c_str());
...
void Pylonframe::PylonAlarmInfo::json(DynamicJsonDocument &doc, uint8_t module){
    doc["pylontech"][String(module)]["Alarm"]["UnreadAlarmValueChange"] = InfoFlags() & PylonInfoFlags::UnreadAlarmValueChange?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["UnreadSwitchingValueChange"] = InfoFlags() & PylonInfoFlags::UnreadSwitchingValueChange?"true":"false";
    for (size_t i = 0; i < CellCount(); i++)
    {
      doc["pylontech"][String(module)]["Alarm"]["CellVoltage"][String(i+1)] = Name(CellVoltage(i));
    }
    doc["pylontech"][String(module)]["Alarm"]["BmsTemperature"] = Name(BmsTemperature());
    doc["pylontech"][String(module)]["Alarm"]["TemperatureCell1to4"] = Name(TemperatureCell1to4());
    doc["pylontech"][String(module)]["Alarm"]["TemperatureCell5to8"] = Name(TemperatureCell5to8());
    doc["pylontech"][String(module)]["Alarm"]["TemperatureCell9to12"] = Name(TemperatureCell9to12());
    doc["pylontech"][String(module)]["Alarm"]["TemperatureCell13to16"] = Name(TemperatureCell13to16());
    if (TemperatureCount() > 5){
        doc["pylontech"][String(module)]["Alarm"]["MosfetTemperature"] = Name(MosfetTemperature());
    }
    doc["pylontech"][String(module)]["Alarm"]["ChargeCurrent"] = Name(ChargeCurrent());
    doc["pylontech"][String(module)]["Alarm"]["ModuleVoltage"] = Name(ModuleVoltage());
    doc["pylontech"][String(module)]["Alarm"]["DischargeCurrent"] = Name(DischargeCurrent());
    doc["pylontech"][String(module)]["Alarm"]["ModuleUnderVoltage"] = Status1() & AlarmStatus1::ModuleUnderVoltage?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["ChargeOverTemperature"] = Status1() & AlarmStatus1::ChargeOverTemperature?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["DischargeOverTemperature"] = Status1() & AlarmStatus1::DischargeOverTemperature?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["DischargeOverCurrent"] = Status1() & AlarmStatus1::DischargeOverCurrent?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["ChargeOverCurrent"] = Status1() & AlarmStatus1::ChargeOverCurrent?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["CellUnderVoltage"] = Status1() & AlarmStatus1::CellUnderVoltage?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["ModuleOverVoltage"] = Status1() & AlarmStatus1::ModuleOverVoltage?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["UsingBatteryModulePower"] = Status2() & AlarmStatus2::UsingBatteryModulePower?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["DischargeMosfet"] = Status2() & AlarmStatus2::DischargeMosfet?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["ChargeMosfet"] = Status2() & AlarmStatus2::ChargeMosfet?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["PreMosfet"] = Status2() & AlarmStatus2::PreMosfet?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["EffectiveChargeCurrent"] = Status3() & AlarmStatus3::EffectiveChargeCurrent?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["EffectiveDischargeCurrent"] = Status3() & AlarmStatus3::EffectiveDischargeCurrent?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["Heater"] = Status3() & AlarmStatus3::Heater?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["FullyCharged"] = Status3() & AlarmStatus3::FullyCharged?"true":"false";
    doc["pylontech"][String(module)]["Alarm"]["Buzzer"] = Status3() & AlarmStatus3::Buzzer?"true":"false";
    auto cellError = CellError();
    for (size_t c = 0; c < 16; c++)
    {
        doc["pylontech"][String(module)]["Alarm"]["CellError"][String(c+1)] = cellError & 1<<c?"true":"false";
    }
}
...
uint16_t Pylonframe::PylonAnalogValue::CellVoltage(size_t cell){
    auto index = 4 * cell + 6;
...
float Pylonframe::PylonAnalogValue::TemperatureCell13to16(){
...
void Pylonframe::PylonAnalogValue::json(DynamicJsonDocument &doc, uint8_t module) {
    ...
    doc["pylontech"][String(module)]["Analog"]["SoC"] =  round(100*(RemainingCapacity()/TotalCapacity()));
